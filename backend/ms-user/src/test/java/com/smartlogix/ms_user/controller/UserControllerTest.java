...
class UserControllerTest {
    ...
    void obtenerUsuario_existente_retorna200() {
        ...
        ResponseEntity<UserResponse> response =
                userController.obtenerUsuario(1L);
    ...
    void registrarUsuario_retorna200() {
        ...
        when(userService.registrarUsuario(any(User.class)))
                .thenReturn(usuarioMock);

        ResponseEntity<UserResponse> response =
                userController.registrarUsuario(request);
    ...
    void actualizarUsername_retorna200() {
        ...
        when(userService.actualizarUsername(1L, "nuevo_admin"))
                .thenReturn(usuarioMock);

        ResponseEntity<UserResponse> response =
                userController.actualizarUsername(1L, request);
    ...
    void eliminarUsuario_retorna204() {
        ...
        ResponseEntity<Void> response =
                userController.eliminarUsuario(1L);
